...
name: uupt-delivery
description: >-
  UU跑腿同城配送服务，支持跑腿配送（帮送/帮取/帮买）和帮帮服务（现场协助/代办/劳务）两种订单类型，覆盖订单询价、发单下单、订单查询、取消订单、跑男实时追踪全流程。当用户表达"送"、"取"、"寄"、"跑腿"、"发单"、"配送"、"帮送"、"帮取"、"帮买"、"代购"、"同城急送"、"帮帮"、"帮我"、"代办"、"代取号"、"代排队"、"陪诊"、"陪护"、"搬东西"、"搬抬"、"装卸"、"小时工"、"临时工"、"打扫卫生"、"布置场地"、"取寄快递"、"琐事代办"、"异地代办"等配送或帮帮需求，或需要查询/取消UU跑腿订单、追踪跑男位置时，使用此skill。
version: 1.0.9
metadata:
  openclaw:
    requires:
