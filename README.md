...
| 订单询价 | 计算配送费用或帮帮服务费用 | 用户想知道价格 |
| 创建配送订单 | 发起跑腿配送（帮送/帮取/帮买：文件、餐饮、鲜花、蛋糕、快递代取送、代购等） | 用户需要同城取送或代买 |
| 创建帮帮订单 | 发起帮帮订单（陪诊陪护、异地代办、代去现场、布置场地、搬抬装卸、小时工、琐事代办、取寄快递等） | 用户需要帮帮或代办 |
